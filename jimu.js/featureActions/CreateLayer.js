      ...
      var popup = new Popup({
        ...
        buttons: [{
          ...
          onClick: lang.hitch(this, function() {
            ...
            featureLayer.id = window.createdFromSelectPrefix + featureLayer.name.replace(/ /g,'');
            
    	    var fields = "";
		    for (index = 0, len = featureLayer.fields.length; index < len; ++index) {
		        	fields = fields + featureLayer.fields[index].name + ":" + featureLayer.fields[index].type + ";";
		    }
