define({
  "common": {
    ...
    "updateGeometry": "Aktualizovat geometrii",
    "preview": "Náhled",
    "date": "Datum",
    "time": "Čas",
    "show": "Zobrazit",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Rozbalit okno",
    "maxWindow": "Maximalizovat okno",
    "restoreWindow": "Obnovení výchozí velikosti okna",
    "closeWindow": "Zavřít okno",
    "expanded": "${value} widgetu rozbaleno",
    "collapsed": "${value} widgetu zabaleno",
    "pressToFocus": "stiskněte klávesu Enter pro zaměření uvnitř ${value}"
  },
  "toggleButton": {
    "toggleOn": "Pokud jej chcete zapnout, stiskněte přepínací tlačítko",
    "toggleOff": "Pokud jej chcete vypnout, stiskněte přepínací tlačítko",
    "toggleOnTimePicker": "Zapnout nástroj pro výběr času",
    "toggleOffTimePicker": "Vypnout nástroj pro výběr času"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Náhled",
    "markerCategory": "Kategorie bodového symbolu",
    "basic": "Základní",
    "arrows": "Šipky",
    "business": "Obchod",
    ...
    "emergencyManagement": "Řízení nouzových situací",
    "generalInfrastructure": "Všeobecná infrastruktura",
    "localGovernment": "Místní samospráva",
    "nationalParkService": "National Park Service",
    "numbers": "Hodnoty",
    "outdoorRecreation": "Venkovní rekreace",
    "peoplePlaces": "Turistické body zájmu",
    "pointsOfInterest": "Body zájmu",
    "safetyHealth": "Bezpečnost zdraví",
    "stateGovernment": "Národní vláda",
    "shapes": "Tvary",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Hodnota ${value} již existuje.",
    "color": "Barva",
    "size": "Velikost",
    "toShow": "Ukázat",
    "colors": "Barvy",
    ...
    "range": "Rozmezí",
    "othersSymbol": "Jiné",
    "othersSymbolTip": "Umožňuje zobrazit nebo skrýt symbol pro nespárované hodnoty."
  },
  "drawBox": {
    "point": "Bod",
    "arrow": "Šipka",
  ...
  "filterBuilder": {
    "inputSearchKey": "Najít či vytvořit hodnotu",
    "createValue": "Vytvořit hodnotu: ${value}",
    ...
    "oneOrZeroMsg": "Zobrazit prvky vrstvy, které odpovídají následujícímu výrazu.",
    "matchMsgAny": "Zobrazit funkce vrstvy, které odpovídají jakémukoliv z následujících výrazů",
    "matchMsgAll": "Zobrazit funkce vrstvy, které odpovídají všem následujícím výrazům",
    "matchMsgSetAny": "Jakýkoliv z následujících výrazů v této sadě je pravdivý",
    "matchMsgSetAll": "Všechny následující výrazy v této sadě jsou pravdivé",
    "all": "Všechny",
    "any": "Libovolný",
    "value": "Hodnota",
    "values": "Hodnoty",
    ...
    "predefinedUniqueTips": "Předdefinovat jedinečné hodnoty",
    "predefinedMultipleTips": "Předdefinovat vícenásobné hodnoty",
    "displayAs": "Zobrazit jako",
    "aDrowdownList": "rozevírací seznam",
    "aExpandedList": "rozšířený seznam",
    "addValuePlaceHolder": "Klikněte dvakrát pro nastavení hodnoty",
    "addLabelPlaceHolder": "Klikněte dvakrát pro nastavení popisku",
    "emptyValueTips": "Umožňuje zobrazit nebo skrýt prázdné prvky v tomto seznamu.",
    "showAll": "Zobrazit vše",
    "showSelected": "Zobrazit pouze vybrané",
    ...
    "notSupportCaseSensitiveTip": "Hostované služby ArcGIS Online nepodporují dotazy rozlišující velikost písmen.",
    "setFilterTip": "Nastavte filtr správně.",
    "noFilterValueTip": "Zadané pole neobsahuje žádné hodnoty.",
    ...
    "setInputType": "Nastavit typ vstupu"
  },
  "featureLayerSource": {
    "layer": "Vrstva",
    "browse": "Procházet",
  ...
  "units": {
    ...
    "degrees": "stupně",
    "degreeMS": "Stupeň-Minuta-Vteřina",
    "degreesAbbr": "stup.",
    "degreeMSAbbr": "dms",
  ...
  "shareLink": {
    ...
    "useOrg": "Použít adresu URL organizace",
    "layerVisibility": "Zapamatovat viditelnost vrstev",
    ...
    "urlEncodedTips": "ID vrstvy jsou kódována pomocí algoritmu Hash kvůli zkrácení adresy URL, protože je tady příliš mnoho informací o viditelnosti vrstvy. Podrobné informace naleznete v nápovědě k widgetu Sdílet.",
    "urlTooLongTips": "Aktuální adresa URL je příliš dlouhá a server ji nemůže interpretovat. Kvůli zkrácení můžete ignorovat informace o viditelnosti. Podrobné informace naleznete v nápovědě k widgetu Sdílet."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Chcete odejít bez uložení provedených změn?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Barva",
    "fieldDisplayChartTip": "Graf se nepodařilo zobrazit. Příliš mnoho kategorií.",
    "legend": "Legenda",
  ...
  "frameworkDatasource": {
    ...
    "addExtraDsTip": "Přejděte na kartu Atribut a kliknutím na možnost Další zdroj dat přidejte data.",
    "widgetOutpusListTip": "Na tomto místě jsou vypsány také výstupy widgetů (pokud existují)."
  },
  "gridLayout": {
    "addWidgetTip": "Z karty Widget sem můžete přidat widgety",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "Zvětšení",
    "addPointLabel": "Přidat bod kliknutím na mapu",
    "multipleNotationLabel": "byla nalezena označení, která odpovídají vašemu vstupu. Potvrďte, co chcete použít:",
