define({
  "common": {
    ...
    "updateGeometry": "Uuenda geomeetria",
    "preview": "Eelvaade",
    "date": "Kuupäev",
    "time": "Aeg",
    "show": "Kuva",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Ava aken",
    "maxWindow": "Maksimeeri aken",
    "restoreWindow": "Taasta akna vaikesuurus",
    "closeWindow": "Sule aken",
    "expanded": "${value} vidin laiendatud",
    "collapsed": "${value} vidin ahendatud",
    "pressToFocus": "vajutage Enter, et fokuseerida ${value}"
  },
  "toggleButton": {
    "toggleOn": "Sisselülitamiseks vajutage vahetamise nuppu",
    "toggleOff": "Väljalülitamiseks vajutage vahetamise nuppu",
    "toggleOnTimePicker": "Lülitage kellaaja valija sisse",
    "toggleOffTimePicker": "Lülitage kellaaja valija välja"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Eelvaade",
    "markerCategory": "Markeri kategooria",
    "basic": "Esmane",
    "arrows": "Nooled",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Väärtus ${value} on juba olemas.",
    "color": "Värv",
    "size": "Suurus",
    "toShow": "Näita",
    "colors": "Värvid",
    ...
    "range": "Ulatus",
    "othersSymbol": "Muu",
    "othersSymbolTip": "Kuva või peida vasteteta väärtuste sümbol."
  },
  "drawBox": {
    "point": "Punkt",
    "arrow": "Nool",
  ...
  "filterBuilder": {
    "inputSearchKey": "Väärtuse otsimine või loomine",
    "createValue": "Loo väärtus: ${value}",
    ...
    "oneOrZeroMsg": "Kuva kihi objekte, mis vastavad järgmisele avaldisele",
    "matchMsgAny": "Kuva kihi objektid, mis vastavad mõnele järgmistest avaldistest",
    "matchMsgAll": "Kuva kihi objektid, mis vastavad kõigile järgmistele avaldistele",
    "matchMsgSetAny": "Mõni järgmistest avaldistest selles komplektis on tõene",
    "matchMsgSetAll": "Kõik järgmised avaldised selles komplektis on tõesed",
    "all": "Kõik",
    "any": "Mõni",
    "value": "Väärtus",
    "values": "Väärtused",
    ...
    "predefinedUniqueTips": "Kordumatute väärtuste eelmääratlemine",
    "predefinedMultipleTips": "Mitme väärtuse eelmääratlemine",
    "displayAs": "Kuva",
    "aDrowdownList": "ripploendina",
    "aExpandedList": "laiendatud loendina",
    "addValuePlaceHolder": "Väärtuse määramiseks topeltklõpsake",
    "addLabelPlaceHolder": "Märgise määramiseks topeltklõpsake",
    "emptyValueTips": "Kuva või peida selles loendis tühi väärtus.",
    "showAll": "Kuva kõik",
    "showSelected": "Kuva ainult valitud",
    ...
    "stringOperatorIsIn": "on loendis",
    "stringOperatorIsNotIn": "pole loendis",
    "stringOperatorIsAnyOf": "on mõni järgmistest",
    "stringOperatorIsNoneOf": "pole ükski järgmistest",
    ...
    "numberOperatorIsAnyOf": "on mõni järgmistest",
    "numberOperatorIsNoneOf": "pole ükski järgmistest",
    ...
    "notSupportCaseSensitiveTip": "ArcGIS Online’i majutatud teenused ei toeta tõstutundlikke päringuid.",
    "setFilterTip": "Määrake filtrid õigesti.",
    "noFilterValueTip": "Määratud väljal puuduvad väärtused.",
  ...
  "itemSelector": {
    ...
    "searchNone": "Me ei leidnud seda, mida otsisite. Palun proovige uuesti",
    "groups": "Grupid",
  ...
  "shareLink": {
    ...
    "useOrg": "Kasutage ettevõtte URL-i",
    "layerVisibility": "Jäta kihtide nähtavus meelde",
    ...
    "urlEncodedTips": "Kihtide IDd on kodeeritud Hash-algoritmiga, et lühendada URLi, kuna kihi nähtavusteavet on liiga palju. Täpsemat teavet leiate Jaga vidina abi alt.",
    "urlTooLongTips": "Praegune URL on liiga pikk ja server ei tarvitse sellest aru saada. Lühendamiseks võib nähtavuse teavet eirata. Täpsemat teavet leiate Jaga vidina abi alt."
  },
  "webSceneLoader": {
  ...
  "statisticsChart": {
    ...
    "color": "Värv",
    "fieldDisplayChartTip": "Diagrammi kuvamine nurjus. Liiga palju kategooriaid.",
    "legend": "Legendiga kaart",
    "columnChart": "Tulpdiagramm",
  ...
  "coordinateControl": {
    "notations": {
      ...
      "MGRS": "MGRS",
      "UTM_H": "UTM (H)",
      "UTM": "Mercatori universaalne põikprojektsioon, UTM",
      "GARS": "GARS",
      "GEOREF": "GEOREF"
    },
    ...
    "copyFailed": "Kopeerida ei saa. Kasutage alternatiivina klahvikombinatsiooni Ctrl+c.",
    ...
    "posNegPrefixLabel": "Lisage positiivsetele ja negatiivsetele arvudele eesliide „+/-”",
    ...
    "zoomLabel": "Suumi",
    "addPointLabel": "Lisa punkt kaardile klõpsamise kaudu",
    "multipleNotationLabel": "leitud tähistust vastab teie sisestatud otsingule. Kinnitage, millist neist soovite kasutada:",
