define({
  "common": {
    ...
    "updateGeometry": "Päivitä geometria",
    "preview": "Esikatselu",
    "date": "Päivämäärä",
    "time": "Kellonaika",
    "show": "Näytä",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Laajenna ikkuna",
    "maxWindow": "Suurenna ikkuna enimmäiskokoon",
    "restoreWindow": "Palauta ikkuna oletuskokoonsa",
    "closeWindow": "Sulje ikkuna",
    "expanded": "${value} pienoisohjelma laajennettu",
    "collapsed": "${value} pienoisohjelma kutistettu",
    "pressToFocus": "kohdista kohteen ${value} sisään painamalla ENTER-näppäintä"
  },
  "toggleButton": {
    "toggleOn": "Ota se käyttöön napsauttamalla vaihtopainiketta",
    "toggleOff": "Poista se käytöstä napsauttamalla vaihtopainiketta",
    "toggleOnTimePicker": "Ota ajan valitsin käyttöön",
    "toggleOffTimePicker": "Poista ajan valitsin käytöstä"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Esikatselu",
    "markerCategory": "Merkintäluokka",
    "basic": "Perus",
    "arrows": "Nuolet",
    "business": "Yritystoiminta",
    "cartographic": "Kartografinen",
    "damage": "Vahinko",
    "disasters": "Katastrofit",
    "emergencyManagement": "Hätätilanteiden hallinta",
    "generalInfrastructure": "Yleinen infrastruktuuri",
    "localGovernment": "Paikallishallinto",
    "nationalParkService": "Kansallispuisto",
    "numbers": "Numerot",
    "outdoorRecreation": "Virkistysalue",
    "peoplePlaces": "Ihmiset ja paikat",
    "pointsOfInterest": "Kiinnostuksenkohteet",
    "safetyHealth": "Turv., terveys",
    "stateGovernment": "Valtionhallinto",
    "shapes": "Muodot",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Arvo ${value} on jo olemassa.",
    "color": "Väri",
    "size": "Koko",
    "toShow": "Näyttäminen",
    "colors": "Värit",
    ...
    "range": "Vaihteluväli",
    "othersSymbol": "Muut",
    "othersSymbolTip": "Näytä tai piilota paikantamattomien arvojen symboli."
  },
  "drawBox": {
    "point": "Piste",
    "arrow": "Nuoli",
  ...
  "filterBuilder": {
    "inputSearchKey": "Etsi tai luo arvo",
    "createValue": "Luo arvo: ${value}",
    ...
    "oneOrZeroMsg": "Näytä ne karttatason kohteet, jotka vastaavat seuraavaa ehtolauseketta",
    "matchMsgAny": "Näytä sellaiset karttatason kohteet, jotka vastaavat mitä tahansa seuraavista ehtolausekkeista",
    "matchMsgAll": "Näytä sellaiset karttatason kohteet, jotka vastaavat kaikkia seuraavia ehtolausekkeita",
    "matchMsgSetAny": "Mitkä tahansa seuraavista tämän joukon ehtolausekkeista ovat tosia",
    "matchMsgSetAll": "Kaikki tämän joukon ehtolausekkeet ovat tosia",
    "all": "Kaikki",
    "any": "Mikä tahansa",
    "value": "Arvo",
    "values": "Arvot",
    ...
    "predefinedUniqueTips": "Ennalta määritetyt yksilölliset arvot",
    "predefinedMultipleTips": "Useita ennalta määritettyjä arvoja",
    "displayAs": "Näytä muodossa",
    "aDrowdownList": "avattava luettelo",
    "aExpandedList": "laajennettu luettelo",
    "addValuePlaceHolder": "Määritä arvo kaksoisnapsauttamalla",
    "addLabelPlaceHolder": "Määritä tunnusteksti kaksoisnapsauttamalla",
    "emptyValueTips": "Näytä tai piilota tyhjä arvo tässä luettelossa.",
    "showAll": "Näytä kaikki",
    "showSelected": "Näytä vain valitut",
    "unCheckAll": "Poista kaikkien valinta",
    "noData": "Aineistoa ei ole.",
    "none": "Ei mitään",
    "and": "ja",
    ...
    "stringOperatorIsIn": "sisältyy luetteloon",
    "stringOperatorIsNotIn": "ei sisälly luetteloon",
    ...
    "notSupportCaseSensitiveTip": "ArcGIS Onlinen isännöidyt palvelut eivät tue kirjainkoon tunnistavaa kyselyä.",
    "setFilterTip": "Määritä suodattimet oikein.",
    "noFilterValueTip": "Määritetyssä kentässä ei ole arvoja.",
    ...
    "inputType": "Lähtöaineiston tyyppi",
    "setInputType": "Määritä lähtöaineiston tyyppi"
  },
  "featureLayerSource": {
    "layer": "Karttataso",
    "browse": "Selaa",
  ...
  "itemSelector": {
    ...
    "searchNone": "Etsimääsi ei löytynyt. Yritä uudelleen.",
    "groups": "Ryhmät",
  ...
  "units": {
    ...
    "degrees": "Asteet",
    "degreeMS": "Astetta-minuuttia-sekuntia",
    "degreesAbbr": "pp",
    "degreeMSAbbr": "dms",
  ...
  "shareLink": {
    ...
    "useOrg": "Käytä organisaation URL-osoitetta",
    "layerVisibility": "Muista karttatason näkyvyys",
    ...
    "urlEncodedTips": "Karttatason tunnukset on koodattu hajautusalgoritmilla URL-osoitteen lyhentämiseksi, koska karttatason näkyvyystietoja on liian paljon. Lisätietoja on Jaa-pienoisohjelman ohjeessa.",
    "urlTooLongTips": "Nykyinen URL-osoite on ylipitkä, eikä palvelin osaa välttämättä tulkita sitä. Voit ohittaa näkyvyystiedot lyhentääksesi URL-osoitetta. Lisätietoja on Jaa-pienoisohjelman ohjeessa."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Haluatko poistua tallentamatta muokkauksia?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Väri",
    "fieldDisplayChartTip": "Kaavion näyttäminen ei onnistunut. Luokkia on liian monta.",
    "legend": "Selite",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "Tarkennus",
    "addPointLabel": "Lisää piste kartan napsautuksesta",
    "multipleNotationLabel": "lähtöaineistoasi vastaavia esitystapoja on löytynyt. Vahvista, mitä haluat käyttää:",
