define({
  "common": {
    ...
    "updateGeometry": "Mettre à jour la géométrie",
    "preview": "Aperçu",
    "date": "Date",
    "time": "Durée",
    "show": "Afficher",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Développer la fenêtre",
    "maxWindow": "Agrandir la fenêtre",
    "restoreWindow": "Rétablir la taille par défaut de la fenêtre",
    "closeWindow": "Fermer la fenêtre",
    "expanded": "Widget ${value} développé",
    "collapsed": "Widget ${value} réduit",
    "pressToFocus": "appuyez sur Entrée pour vous concentrer sur l’intérieur de ${value}"
  },
  "toggleButton": {
    "toggleOn": "Appuyez sur le bouton bascule pour l’activer",
    "toggleOff": "Appuyez sur le bouton bascule pour le désactiver",
    "toggleOnTimePicker": "Activer le sélecteur temporel",
    "toggleOffTimePicker": "Désactiver le sélecteur temporel"
  },
  "fieldStatistics": {
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "La valeur ${value} existe déjà.",
    "color": "Couleur",
    "size": "Taille",
    "toShow": "A afficher",
    "colors": "Couleurs",
    ...
    "range": "Plage",
    "othersSymbol": "Autres",
    "othersSymbolTip": "Affichez ou masquez le symbole des valeurs non appariées."
  },
  "drawBox": {
    "point": "Point",
    "arrow": "Flèche",
  ...
  "filterBuilder": {
    ...
    "addValuePlaceHolder": "Double-cliquer pour définir la valeur",
    "addLabelPlaceHolder": "Double-cliquer pour définir l’étiquette",
    "emptyValueTips": "Affichez ou masquez la valeur vide dans cette liste.",
    "showAll": "Afficher tout",
    "showSelected": "Afficher uniquement la sélection",
    ...
    "noFilterValueTip": "Le champ spécifié ne contient aucune valeur.",
  ...
  "itemSelector": {
    ...
    "searchNone": "Votre recherche n’a pas abouti. Veuillez réessayer.",
    "groups": "Groupes",
  ...
  "shareLink": {
    ...
    "layerVisibility": "Mémoriser la visibilité des couches",
    ...
    "urlEncodedTips": "Les ID de couche sont codés avec l’algorithme de hachage pour raccourcir l’URL car les informations sur la visibilité des couches sont trop nombreuses. Reportez-vous à l’aide du widget Partager pour en savoir plus.",
    "urlTooLongTips": "L’URL actuelle est trop longue et risque de ne pas être interprétée par le serveur. Vous pouvez ignorer les informations sur la visibilité pour la raccourcir. Reportez-vous à l’aide du widget Partager pour en savoir plus."
  },
  "webSceneLoader": {
  ...
  "coordinateControl": {
    ...
    "copyFailed": "Copie impossible. Utilisez CTRL+C comme alternative.",
    ...
    "editCoordinateDialogTitle": "Définir la chaîne de format des coordonnées",
    "rememberDecisionLabel": "Mémoriser ma décision et ne plus me demander.<br/>",
    "coordinateInputLabel": "Entrez des coordonnées ou cliquez sur une carte",
    "zoomLabel": "Zoom",
    "addPointLabel": "Ajouter un point en cliquant sur la carte",
    "multipleNotationLabel": "notations trouvées correspondant à votre entrée. Indiquez celles que vous voulez utiliser :",
