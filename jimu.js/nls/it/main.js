define({
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Espandi finestra",
    "maxWindow": "Ingrandisci finestra",
    "restoreWindow": "Ripristina le dimensioni predefinite della finestra",
    "closeWindow": "Chiudi finestra",
    "expanded": "Espansione widget ${value}",
    "collapsed": "Compressione widget ${value}",
    "pressToFocus": "premi Invio per Enter per focalizzarsi all’interno di ${value}"
  },
  "toggleButton": {
    "toggleOn": "Premi il pulsante di selezione per attivare",
    "toggleOff": "Premi il pulsante di selezione per disattivare",
    "toggleOnTimePicker": "Accendi selettore di ora",
    "toggleOffTimePicker": "Spendi selettore di ora"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Anteprima",
    "markerCategory": "Categoria marcatore",
    "basic": "Base",
    "arrows": "Frecce",
    "business": "Aziende",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Il valore ${value} esiste già.",
    "color": "Colore",
    "size": "Dimensione",
    "toShow": "Da mostrare",
    "colors": "Colori",
    ...
    "range": "Intervallo",
    "othersSymbol": "Altri",
    "othersSymbolTip": "Mostra o nasconde il simbolo per i valori non abbinati."
  },
  "drawBox": {
    "point": "Punto",
    "arrow": "Freccia",
  ...
  "filterBuilder": {
    ...
    "emptyValueTips": "Mostra o nasconde il valore vuoto in questo elenco.",
    ...
    "stringOperatorIsIn": "è presente in",
    "stringOperatorIsNotIn": "non è presente in",
    ...
    "cascadeFilterTip": "Mostra solo i valori filtrati in base a espressioni precedenti",
  ...
  "shareLink": {
    ...
    "layerVisibility": "Ricorda visibilità dei layer",
    ...
    "urlEncodedTips": "Gli ID dei layer sono codificati con l'algoritmo di Hash per abbreviare l'URL, poiché vi sono troppe informazioni sulla visibilità del layer. Per ulteriori dettagli, vedere la guida del widget Condividi.",
    "urlTooLongTips": "L'attuale URL è troppo lungo e non può essere interpretato dal server. È possibile ignorare le informazioni sulla visibilità per accorciarle. Per ulteriori dettagli, vedere la guida del widget Condividi."
  },
  "webSceneLoader": {
  ...
  "map": {
    ...
    "layerLoadedError": "Impossibile aggiungere il layer ${layers} alla mappa."
  },
  "popup": {
  ...
  "coordinateControl": {
    ...
    "MGRSNotation": "MGRS",
    "USNGNotation": "USNG",
    "UTMBandNotation": "UTM - Lettera della fascia",
    "UTMHemNotation": "UTM - Emisfero (N/S)",
    "formatInput": "Input formato",
    "copyAll": "Copia tutto",
    "copySuccessful": "Copia riuscita",
    "copyFailed": "Impossibile copiare. In alternativa, premere ctrl+C.",
    ...
    "rememberDecisionLabel": "Ricorda l’impostazione e non chiedere più.<br/>",
    "coordinateInputLabel": "Immettere le coordinate o fare clic sulla mappa",
    "zoomLabel": "Zoom",
    "addPointLabel": "Aggiungi punto da clic sulla mappa",
    "multipleNotationLabel": "Trovate notazioni corrispondenti all’input. Confermare quale si desidera utilizzare:",
