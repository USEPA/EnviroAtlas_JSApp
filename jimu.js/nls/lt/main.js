define({
  "common": {
    ...
    "updateGeometry": "Atnaujinti geometriją",
    "preview": "Peržiūra",
    "date": "Data",
    "time": "Laikas",
    "show": "Rodyti",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Išskleisti langą",
    "maxWindow": "Išdidinti langą",
    "restoreWindow": "Atkurti numatytąjį lango dydį",
    "closeWindow": "Uždaryti langą",
    "expanded": "${value} valdikliai išskleisti",
    "collapsed": "${value} valdikliai suskleisti",
    "pressToFocus": "paspauskite Enter, norėdami sutelkt į ${value} vidų"
  },
  "toggleButton": {
    "toggleOn": "Paspauskite perjungimo mygtuką, kad įjungtumėte",
    "toggleOff": "Paspauskite perjungimo mygtuką, kad išjungtumėte",
    "toggleOnTimePicker": "Įjungti laiko parinkiklį",
    "toggleOffTimePicker": "Išjungti laiko parinkiklį"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Peržiūra",
    "markerCategory": "Žymeklio kategorija",
    "basic": "Bazinis",
    "arrows": "Rodyklės",
    "business": "Verslas",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Reikšmė ${value} jau yra.",
    "color": "Spalva",
    "size": "Dydis",
    "toShow": "Rodyti",
    "colors": "Spalvos",
    ...
    "range": "Intervalas",
    "othersSymbol": "Kita",
    "othersSymbolTip": "Rodyti arba slėpti nesuderintų reikšmių simbolį."
  },
  "drawBox": {
    "point": "Taškas",
    "arrow": "Rodyklė",
  ...
  "filterBuilder": {
    "inputSearchKey": "Rasti arba kurti reikšmę",
    "createValue": "Kurti reikšmę: ${value}",
    ...
    "oneOrZeroMsg": "Rodyti elementus sluoksnyje, kurie atitinka šią sąlygą",
    "matchMsgAny": "Rodyti elementus sluoksnyje, kurie atitinka bet kurias iš šių sąlygų",
    "matchMsgAll": "Rodyti elementus sluoksnyje, kurie atitinka visas iš šių sąlygų",
    "matchMsgSetAny": "Bet kurios iš šioje grupėje esančių sąlygų yra teisingos",
    "matchMsgSetAll": "Visos iš šioje grupėje esančių sąlygų yra teisingos",
    "all": "Viskas",
    "any": "Bet kuri",
    "value": "Reikšmė",
    "values": "Reikšmės",
    "field": "Laukas",
    "unique": "Unikalios",
    "uniquePredefined": "Unikalios (apibrėžtos iš anksto)",
    "multiple": "Sudėtinės",
    "multiplePredefined": "Sudėtinės (apibrėžtos iš anksto)",
    "predefinedUniqueTips": "Iš anksto apibrėžti unikalias reikšmes",
    "predefinedMultipleTips": "Iš anksto apibrėžti sudėtines reikšmes",
    "displayAs": "Rodyti kaip",
    "aDrowdownList": "išskleidžiamą sąrašą",
    "aExpandedList": "išplėstą sąrašą",
    "addValuePlaceHolder": "Dukart spustelėkite, kad nustatytumėte reikšmę",
    "addLabelPlaceHolder": "Dukart spustelėkite, kad nustatytumėte žymę",
    "emptyValueTips": "Rodyti arba slėpti tuščias reikšmes šiame sąraše.",
    "showAll": "Rodyti visus",
    "showSelected": "Rodyti tik pasirinktus",
    ...
    "stringOperatorIsIn": "yra",
    "stringOperatorIsNotIn": "nėra",
    ...
    "notSupportCaseSensitiveTip": "ArcGIS Online talpinamos paslaugos nepalaiko užklausos, kurioje skiriamos didžiosios ir mažosios raidės.",
    "setFilterTip": "Nustatykite filtrus tinkamai.",
    "noFilterValueTip": "Nurodytas laukas reikšmių neturi.",
  ...
  "units": {
    ...
    "degrees": "Laipsniai",
    "degreeMS": "Laipsniai-Minutės-Sekundės",
    "degreesAbbr": "dd",
    "degreeMSAbbr": "dms",
  ...
  "shareLink": {
    ...
    "auth": "Autentikuokite naudotoją automatiškai",
    "useOrg": "Naudoti organizacijos URL",
    "layerVisibility": "Prisiminti sluoksnio matomumą",
    "linkPreview": "Nuorodos peržiūra",
    "useShortenLink": "Trumpoji nuoroda",
    "shareMapUrlExtent": "Bendrinti esamo žemėlapio aprėptį",
    "shareToWebTips": "Ši aplikacija nėra bendrinama viešai. Naudotojams ji gali būti nepasiekiama.",
    "urlEncodedTips": "Sluoksnių ID užkoduojami maišos algoritmu, siekiant sutrumpinti URL, kadangi jame yra per daug sluoksnio matomumo informacijos. Daugiau informacijos rasite valdiklyje Bendrinti.",
    "urlTooLongTips": "Dabartinis URL yra pernelyg ilgas ir serveris gali jo neinterpretuoti. Norėdami jį sutrumpinti, galite atsisakyti matomumo informacijos. Daugiau informacijos rasite valdiklyje Bendrinti."
  },
  "webSceneLoader": {
  ...
  "map": {
    ...
    "layerLoadedError": "Sluoksnio ${layers} negalima įkelti į žemėlapį."
  },
  "popup": {
  ...
  "statisticsChart": {
    ...
    "color": "Spalva",
    "fieldDisplayChartTip": "Nepavyko parodyti diagramos. Per daug kategorijų.",
    "legend": "Legenda",
    "columnChart": "Stulpelinė diagrama",
  ...
  "coordinateControl": {
    ...
    "copyFailed": "Nukopijuoti nepavyko. Kaip alternatyvą naudokite Ctrl + C.",
    ...
    "latLongWarningMessage": "Įvesties koordinatė buvo nustatyta, kaip turinti platumos ir ilgumos prefikso ir sufikso reikšmes, grąžinta koordinatė pagrįsta prefiksu.",
    ...
    "rememberDecisionLabel": "Prisiminti mano pasirinkimą ir daugiau nebeklausti.<br/>",
    "coordinateInputLabel": "Įveskite koordinates arba paspauskite žemėlapyje",
    "zoomLabel": "Priartinti",
    "addPointLabel": "Įtraukti tašką paspaudus žemėlapyje",
    "multipleNotationLabel": "rasti įvestį atitinkantys žymėjimai. Patvirtinkite, ką norėtumėte naudoti:",
