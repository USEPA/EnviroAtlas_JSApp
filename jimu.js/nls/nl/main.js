define({
  "common": {
    ...
    "updateGeometry": "Geometrie bijwerken",
    "preview": "Voorbeeld",
    "date": "Datum",
    "time": "Tijd",
    "show": "Weergeven",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Venster uitvouwen",
    "maxWindow": "Venster maximaliseren",
    "restoreWindow": "Venster herstellen naar standaardgrootte",
    "closeWindow": "Venster sluiten",
    "expanded": "${value} widget uitgeklapt",
    "collapsed": "${value} widget ingeklapt",
    "pressToFocus": "druk op Enter om de focus binnen ${value} te plaatsen"
  },
  "toggleButton": {
    "toggleOn": "Druk op de wisselknop om het aan te zetten",
    "toggleOff": "Druk op de wisselknop om het uit te zetten",
    "toggleOnTimePicker": "Tijdkiezer aanzetten",
    "toggleOffTimePicker": "Tijdkiezer uitzetten"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Voorbeeld",
    "markerCategory": "Categorie markering",
    "basic": "Eenvoudig",
    "arrows": "Pijlen",
    "business": "Economie",
    ...
    "damage": "Schade",
    "disasters": "Rampen",
    "emergencyManagement": "Beheer van noodgevallen",
    "generalInfrastructure": "Algemene infrastructuur",
    "localGovernment": "Lokale overheid",
    "nationalParkService": "National Park Service",
    "numbers": "Nummers",
    "outdoorRecreation": "Recreatie in openlucht",
    "peoplePlaces": "Openbare plaatsen",
    "pointsOfInterest": "Nuttige plaatsen",
    "safetyHealth": "Veiligheid en gezondheid",
    "stateGovernment": "Provinciale overheid",
    "shapes": "Vormen",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "De waarde ${value} bestaat al.",
    "color": "Kleur",
    "size": "Grootte",
    ...
    "range": "Bereik",
    "othersSymbol": "Overig",
    "othersSymbolTip": "Het symbool tonen of verbergen voor waarden die niet overeenkomen."
  },
  "drawBox": {
    "point": "Punt",
    "arrow": "Pijl",
  ...
  "filterBuilder": {
    "inputSearchKey": "Zoek of maak een waarde",
    "createValue": "Waarde maken: ${value}",
    "addAnotherExpression": "Expressie toevoegen",
    ...
    "oneOrZeroMsg": "Objecten in de kaartlaag weergeven die overeenkomen met de volgende expressie",
    "matchMsgAny": "Geef objecten weer in de laag die overeenstemmen met enige van de volgende expressies",
    "matchMsgAll": "Geef objecten weer in de laag die overeenstemmen met elk van de volgende expressies",
    "matchMsgSetAny": "Eén van de volgende expressies in deze set zijn waar",
    "matchMsgSetAll": "Alle volgende expressies in deze set zijn waar",
    "all": "Alle",
    "any": "Eén",
    "value": "Waarde",
    "values": "Waarden",
    ...
    "predefinedUniqueTips": "Unieke waarden vooraf bepalen",
    "predefinedMultipleTips": "Meerdere waarden vooraf bepalen",
    "displayAs": "Weergeven als",
    "aDrowdownList": "een keuzelijst",
    "aExpandedList": "een uitgevouwen lijst",
    "addValuePlaceHolder": "Dubbelklik om de waarde in te stellen",
    "addLabelPlaceHolder": "Dubbelklik om de tabel in te stellen",
    "emptyValueTips": "Lege waarden tonen of verbergen in deze lijst.",
    "showAll": "Alles tonen",
    "showSelected": "Alleen geselecteerde weergeven",
    "unCheckAll": "Alles deselecteren",
    "noData": "Er is geen data.",
    "none": "Geen",
    "and": "en",
    ...
    "stringOperatorIsNotIn": "is niet in",
    ...
    "notSupportCaseSensitiveTip": "ArcGIS Online hosted services ondersteunen geen hoofdlettergevoelige query.",
    "setFilterTip": "Stel filters correct in.",
    "noFilterValueTip": "Het opgegeven veld heeft geen waarden.",
    ...
    "setInputType": "Invoertype instellen"
  },
  "featureLayerSource": {
    "layer": "Kaartlaag",
    "browse": "Bladeren",
  ...
  "itemSelector": {
    ...
    "searchNone": "We hebben niet gevonden wat u zocht. Probeer het opnieuw.",
    "groups": "Groepen",
  ...
  "units": {
    ...
    "degrees": "Graden",
    "degreeMS": "Graden-minuten-seconden",
    "degreesAbbr": "dg",
    "degreeMSAbbr": "dms",
  ...
  "shareLink": {
    ...
    "useOrg": "Gebruik de url van de organisatie",
    "layerVisibility": "Laagzichtbaarheid onthouden",
    ...
    "urlEncodedTips": "De ID's van de lagen zijn geëncodeerd met een hashingalgoritme om de URL in te korten, aangezien er teveel informatie is over de laagzichtbaarheid. Zie de hulp voor de widget ‘Delen’ voor meer details.",
    "urlTooLongTips": "De huidige URL is te lang en kan mogelijk niet worden geïnterpreteerd door de server. U kunt zichtbaarheidsinformatie negeren om deze te verkorten. Zie de hulp voor de widget ‘Delen’ voor meer details."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Wilt u de pagina verlaten zonder de bewerkingen op te slaan?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Kleur",
    "fieldDisplayChartTip": "Kan diagram niet weergeven. Te veel categorieën.",
    "legend": "Legenda",
    "columnChart": "Kolomdiagram",
  ...
  "coordinateControl": {
    ...
    "formatInput": "Invoerformaat",
    "copyAll": "Alles kopiëren",
    "copySuccessful": "Kopiëren succesvol",
    "copyFailed": "Niet mogelijk om te kopiëren. Gebruik ctrl+c als alternatief.",
    ...
    "zoomLabel": "Zoom",
    "addPointLabel": "Punt toevoegen van kaartklik",
    "multipleNotationLabel": "notaties gevonden die overeenstemmen met uw input. Bevestig welke u wilt gebruiken:",
