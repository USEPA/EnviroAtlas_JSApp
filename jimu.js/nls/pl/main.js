define({
  "common": {
    ...
    "updateGeometry": "Aktualizuj geometrię",
    "preview": "Podgląd",
    "date": "Data",
    "time": "Czas",
    "show": "Pokaż",
  ...
  "skips": {
    ...
    "headerController": "Przejdź do kontrolera nagłówka",
    "map": "Przejdź do mapy",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Rozwiń okno",
    "maxWindow": "Maksymalizuj okno",
    "restoreWindow": "Przywróć domyślny rozmiar okna",
    "closeWindow": "Zamknij okno",
    "expanded": "Widżet ${value} został rozwinięty",
    "collapsed": "Widżet ${value} został zwinięty",
    "pressToFocus": "Naciśnij klawisz Enter, aby aktywować ${value}"
  },
  "toggleButton": {
    "toggleOn": "Naciśnij przełącznik, aby go włączyć",
    "toggleOff": "Naciśnij przełącznik, aby go wyłączyć",
    "toggleOnTimePicker": "Włącz narzędzie wyboru czasu",
    "toggleOffTimePicker": "Wyłącz narzędzie wyboru czasu"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    ...
    "markerCategory": "Kategoria znaczników",
    "basic": "Podstawowy",
    "arrows": "Strzałki",
    "business": "Biznes",
    ...
    "emergencyManagement": "Zarządzanie kryzysowe",
    "generalInfrastructure": "Infrastruktura ogólna",
    "localGovernment": "Administracja lokalna",
    ...
    "pointsOfInterest": "Punkty POI",
    "safetyHealth": "Higiena i bezpieczeństwo",
    "stateGovernment": "Administracja rządowa",
    "shapes": "Kształty",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Wartość ${value} już istnieje.",
    "color": "Kolor",
    "size": "Rozmiar",
    "toShow": "Widoczne",
    "colors": "Kolory",
    ...
    "range": "Zakres",
    "othersSymbol": "Inne",
    "othersSymbolTip": "Pokaż lub ukryj symbol dla niedopasowanych wartości."
  },
  "drawBox": {
    "point": "Punkt",
    "arrow": "Strzałka",
  ...
  "filterBuilder": {
    "inputSearchKey": "Znajdź lub utwórz wartość",
    "createValue": "Utwórz wartość: ${value}",
    ...
    "oneOrZeroMsg": "Wyświetl w warstwie obiekty spełniające następujące wyrażenie",
    "matchMsgAny": "Wyświetl te obiekty w warstwie, które są zgodne z dowolnym spośród poniższych wyrażeń",
    "matchMsgAll": "Wyświetl te obiekty w warstwie, które są zgodne ze wszystkimi poniższymi wyrażeniami",
    "matchMsgSetAny": "Prawdziwe jest dowolne wyrażenie w tym zbiorze",
    "matchMsgSetAll": "Prawdziwe są wszystkie wyrażenia w tym zbiorze",
    "all": "Wszystkie",
    "any": "Dowolne",
    "value": "Wartość",
    "values": "Wartości",
    "field": "Pole",
    "unique": "Unikalne",
    "uniquePredefined": "Unikalne (wstępnie zdefiniowane)",
    "multiple": "Wiele",
    "multiplePredefined": "Wiele (wstępnie zdefiniowane)",
    "predefinedUniqueTips": "Wstępnie zdefiniowane wartości unikalne",
    "predefinedMultipleTips": "Wstępnie zdefiniowanych wiele wartości",
    "displayAs": "Wyświetl jako",
    "aDrowdownList": "lista rozwijana",
    "aExpandedList": "lista rozwinięta",
    "addValuePlaceHolder": "Kliknij dwukrotnie, aby ustawić wartość",
    "addLabelPlaceHolder": "Kliknij dwukrotnie, aby ustawić etykietę",
    "emptyValueTips": "Pokaż lub ukryj wartość pustą na tej liście.",
    "showAll": "Pokaż wszystkie",
    "showSelected": "Pokaż tylko wybrane",
    "unCheckAll": "Wyłącz zaznaczenie wszystkich",
    "noData": "Brak danych.",
    "none": "Brak",
    "and": "i",
    ...
    "stringOperatorIsIn": "znajduje się na",
    "stringOperatorIsNotIn": "nie znajduje się w",
    ...
    "dateOperatorIsIn": "znajduje się na",
    "dateOperatorIsNotIn": "nie znajduje się w",
    ...
    "notSupportCaseSensitiveTip": "Hostowane usługi ArcGIS Online nie obsługują zapytań rozróżniających wielkość liter.",
    "setFilterTip": "Skonfiguruj poprawnie filtry.",
    "noFilterValueTip": "Określone pole nie ma wartości.",
    "listValues": "Wyświetl listę wartości",
    "cascadeFilterTip": "Wyświetlaj tylko wartości przefiltrowane przez poprzednie wyrażenia",
    ...
    "dateOptions": "Opcje dat",
    "startDateOptions": "Opcje dat początkowych",
    "endDateOptions": "Opcje dat końcowych",
    "custom": "data...",
    "today": "dzisiaj",
    "yesterday": "wczoraj",
    "tomorrow": "jutro",
    "atLeastOne": "Należy zaznaczyć co najmniej jedną opcję daty.",
    "notUncheckedCurrent": "Nie można wyłączyć zaznaczenia wybranej opcji daty.",
    "theseDays": "te dni",
    "thisWeek": "tym tygodniu",
    "thisMonth": "tym miesiącu",
    "thisQuarter": "tym kwartale",
    "thisYear": "tym roku",
    "inputType": "Typ wejściowy",
    "setInputType": "Ustaw typ wejściowy"
  },
  "featureLayerSource": {
    "layer": "Warstwa",
    "browse": "Przeglądaj",
  ...
  "itemSelector": {
    ...
    "searchNone": "Nie można odnaleźć wyszukiwanego elementu. Spróbuj ponownie.",
    "groups": "Grupy",
  ...
  "units": {
    ...
    "degrees": "Stopnie",
    "degreeMS": "Stopnie-Minuty-Sekundy",
    "degreesAbbr": "st. dziesiętne",
    "degreeMSAbbr": "dms",
  ...
  "featureSetChooser": {
    ...
    "selectByPoint": "Wybierz za pomocą punktu",
    "selectByPolygon": "Wybierz poligonem",
    "selectByCircle": "Wybierz okręgiem",
    "selectByLine": "Wybierz linią",
    "selectByFreehandPolygon": "Wybierz za pomocą narzędzia lasso",
  ...
  "shareLink": {
    ...
    "useOrg": "Użyj adresu URL instytucji",
    "layerVisibility": "Pamiętaj widoczność warstw",
    ...
    "urlEncodedTips": "Identyfikatory warstw są zakodowane przy użyciu algorytmu tworzenia skrótów w celu skrócenia adresów URL, ponieważ istnieje zbyt wiele informacji o widoczności warstwy. Więcej szczegółów można znaleźć w systemie pomocy do widżetu Udostępnianie.",
    "urlTooLongTips": "Bieżący adres URL jest zbyt długi i może nie zostać zinterpretowany przez serwer. Można zignorować informacje o widoczności, aby go skrócić. Więcej szczegółów można znaleźć w systemie pomocy do widżetu Udostępnianie."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Czy chcesz wyjść bez zapisywania zmian?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Kolor",
    "fieldDisplayChartTip": "Nie powiodło się wyświetlenie wykresu. Zbyt wiele kategorii.",
    "legend": "Legenda",
  ...
  "coordinateControl": {
    ...
    "addPointLabel": "Dodaj punkt, klikając na mapie",
    "multipleNotationLabel": "- liczba znalezionych notacji zgodnych z danymi wejściowymi. Wybierz, której chcesz użyć:",
    ...
    "tooltip": "Kliknij na mapie, aby dodać punkt"
  },
