define({
  "common": {
    ...
    "updateGeometry": "Atualizar Geometria",
    "preview": "Visualizar",
    "date": "Data",
    "time": "Tempo",
    "show": "Mostrar",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Desdobrar janela",
    "maxWindow": "Maximizar janela",
    "restoreWindow": "Restaurar janela para tamanho padrão",
    "closeWindow": "Fechar janela",
    "expanded": "${value} widget expandido",
    "collapsed": "${value} widget recolhido",
    "pressToFocus": "pressione Enter para focar no ${value}"
  },
  "toggleButton": {
    "toggleOn": "Pressione o botão de alternar para ativá-lo",
    "toggleOff": "Pressione o botão de alternar para desativá-lo",
    "toggleOnTimePicker": "Ativar seletor de tempo",
    "toggleOffTimePicker": "Desativar seletor de tempo"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Visualizar",
    "markerCategory": "Categoria de Marcador",
    "basic": "Básico",
    "arrows": "Setas",
    "business": "Negócio",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "O valor ${value} já existe.",
    "color": "Cor",
    "size": "Tamanho",
    "toShow": "Para mostrar",
    "colors": "Cores",
    ...
    "range": "Intervalo",
    "othersSymbol": "Outros",
    "othersSymbolTip": "Mostra ou oculta o símbolo dos valores não correspondentes."
  },
  "drawBox": {
    "point": "Ponto",
    "arrow": "Seta",
  ...
  "filterBuilder": {
    "inputSearchKey": "Localizar ou criar um valor",
    "createValue": "Criar valor: ${value}",
    ...
    "oneOrZeroMsg": "Exibe as feições na camada que correspondem à seguinte expressão",
    "matchMsgAny": "Exibir feições na camada que correspondem a uma das seguintes expressões",
    "matchMsgAll": "Exibir feições na camada que correspondem a todas as seguintes expressões",
    "matchMsgSetAny": "Qualquer uma das seguintes expressões neste conjunto são verdadeiras",
    "matchMsgSetAll": "Todas as seguintes expressões neste conjunto são verdadeiras",
    "all": "Todos",
    "any": "Nenhum",
    "value": "Valor",
    "values": "Valores",
    "field": "Campo",
    "unique": "Único",
    "uniquePredefined": "Único (pré-definido)",
    "multiple": "Múltiplo",
    "multiplePredefined": "Múltiplo (pré-definido)",
    "predefinedUniqueTips": "Valores únicos pré-definidos",
    "predefinedMultipleTips": "Múltiplos valores pré-definidos",
    "displayAs": "Exibir como",
    "aDrowdownList": "uma lista suspensa",
    "aExpandedList": "uma lista expandida",
    "addValuePlaceHolder": "Clique duas vezes para definir o valor",
    "addLabelPlaceHolder": "Clique duas vezes para definir o rótulo",
    "emptyValueTips": "Mostra ou oculta valor vazio nesta lista.",
    "showAll": "Mostrar todos",
    "showSelected": "Mostrar somente selecionados",
    ...
    "stringOperatorIsIn": "está em",
    "stringOperatorIsNotIn": "não está em",
    ...
    "notSupportCaseSensitiveTip": "Os serviços hospedados do ArcGIS Online não oferecem suporte à consulta que diferencia letra maiúscula e letra minúscula.",
    "setFilterTip": "Configure o filtro corretamente.",
    "noFilterValueTip": "O campo especificado não tem nenhum valor.",
  ...
  "itemSelector": {
    ...
    "searchNone": "Não encontramos o que você estava procurando. Tente novamente.",
    "groups": "Grupos",
  ...
  "shareLink": {
    ...
    "useOrg": "Utilizar a URL da organização",
    "layerVisibility": "Lembrar visibilidade da camada",
    ...
    "urlEncodedTips": "Os IDs de camada são codificados com o algoritmo Hash para encurtar a URL, pois há muitas informações de visibilidade da camada. Consulte a ajuda do widget Compartilhar para mais detalhes.",
    "urlTooLongTips": "A URL atual é excessiva e não pode ser interpretada pelo servidor. Você pode ignorar as informações de visibilidade para encurtá-las. Consulte a ajuda do widget Compartilhar para mais detalhes."
  },
  "webSceneLoader": {
  ...
  "map": {
    ...
    "layerLoadedError": "A camada ${layers} não pode ser adicionada no mapa."
  },
  "popup": {
  ...
  "statisticsChart": {
    ...
    "color": "Cor",
    "fieldDisplayChartTip": "Falha ao exibir gráfico. Muitas categorias.",
    "legend": "Legenda",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "Zoom",
    "addPointLabel": "Adicionar ponto a partir do clique no mapa",
