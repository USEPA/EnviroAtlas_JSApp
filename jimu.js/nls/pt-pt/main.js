define({
  ...
  "panelHeader": {
    ...
    "restoreWindow": "Restaurar janela para o tamanho predefinido",
    "closeWindow": "Fechar janela",
    "expanded": "${value} widget expandido",
    "collapsed": "${value} widget fechado",
    "pressToFocus": "premir Enter para focar o interior de ${value}"
  },
  "toggleButton": {
    "toggleOn": "Premir o botão alternar para a ativar",
    "toggleOff": "Premir o botão alternar para a desativar",
    "toggleOnTimePicker": "Ativar seletor de hora",
    "toggleOffTimePicker": "Desativar seletor de hora"
  },
  "fieldStatistics": {
  ...
  "rendererChooser": {
    ...
    "range": "Intervalo",
    "othersSymbol": "Outros",
    "othersSymbolTip": "Exibir ou ocultar o símbolo para valores sem correspondência."
  },
  "drawBox": {
    "point": "Ponto",
    "arrow": "Seta",
  ...
  "filterBuilder": {
    "inputSearchKey": "Encontrar ou criar um valor",
    ...
    "oneOrZeroMsg": "Mostrar elementos na camada que correspondam à expressão seguinte",
    "matchMsgAny": "Exibir elementos da camada que correspondam a qualquer uma das seguintes expressões",
    "matchMsgAll": "Exibir elementos da camada que correspondam a todas as seguintes expressões",
    "matchMsgSetAny": "Qualquer das seguintes expressões deste conjunto são verdadeiras",
    "matchMsgSetAll": "Todas as seguintes expressões deste conjunto são verdadeiras",
    "all": "Todos",
    "any": "Qualquer",
    "value": "Valor",
    "values": "Valores",
    "field": "Campo",
    "unique": "Único",
    "uniquePredefined": "Único (predefinido)",
    "multiple": "Múltiplos",
    "multiplePredefined": "Múltiplos (predefinido)",
    "predefinedUniqueTips": "Predefinir valores únicos",
    "predefinedMultipleTips": "Predefinir valores múltiplos",
    "displayAs": "Exibir como",
    "aDrowdownList": "Uma lista pendente",
    "aExpandedList": "Uma lista expandida",
    "addValuePlaceHolder": "Duplo clique para definir valor",
    "addLabelPlaceHolder": "Duplo clique para definir rótulo",
    "emptyValueTips": "Exibir ou ocultar valor vazio nesta lista.",
    "showAll": "Exibir Todos",
    "showSelected": "Exibir selecionados apenas",
    ...
    "notSupportCaseSensitiveTip": "Os serviços alojados ArcGIS Online não suportam consulta que distingue letras maiúsculas de minúsculas.",
    "setFilterTip": "Por favor, defina os filtros corretamente.",
    "noFilterValueTip": "O campo especifico não tem valores",
    "listValues": "Listar valores",
    "cascadeFilterTip": "Apenas exibir valores filtrados por expressões anteriores.",
  ...
  "itemSelector": {
    ...
    "searchNone": "Não foi possível encontrar o que procura. Tente novamente.",
    "groups": "Grupos",
  ...
  "shareLink": {
    ...
    "useOrg": "Utilizar o URL da organização",
    "layerVisibility": "Lembrar visibilidade de camadas",
    ...
    "urlEncodedTips": "As ID de camadas são codificadas com algoritmo Hash para abreviar o URL, uma vez que existem demasiadas informações visíveis da camada. Consulte a ajuda do widget Partilhar para mais informações.",
    "urlTooLongTips": "O URL atual é demasiado longo e poderá não ser interpretado pelo servidor. Poderá ignorar informações visíveis para o abreviar. Consulte a ajuda do widget Partilhar para mais informações."
  },
  "webSceneLoader": {
  ...
  "statisticsChart": {
    ...
    "color": "Cor",
    "fieldDisplayChartTip": "Ocorreu uma falha ao exibir o gráfico. Demasiadas categorias.",
    "legend": "Legenda",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "Zoom",
    "addPointLabel": "Adicionar ponto com clique no mapa",
