define({
  "common": {
    ...
    "updateGeometry": "Actualizare geometrie",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Depliere fereastră",
    "maxWindow": "Maximizare fereastră",
    "restoreWindow": "Restaurare fereastră la mărime implicită",
    "closeWindow": "Închidere fereastră",
    "expanded": "Widget ${value} extins",
    "collapsed": "Widget ${value} restrâns",
    "pressToFocus": "Apăsați pe Enter pentru a focaliza în ${value}"
  },
  "toggleButton": {
    "toggleOn": "Apăsați pe butonul de comutare pentru a-l porni",
    "toggleOff": "Apăsați pe butonul de comutare pentru a-l opri",
    "toggleOnTimePicker": "Activați selectorul de oră",
    "toggleOffTimePicker": "Dezactivați selectorul de oră"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Previzualizare",
    "markerCategory": "Categorie marcator",
    "basic": "De bază",
    "arrows": "Săgeţi",
    "business": "Afacere",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Valoarea ${value} deja există.",
    "color": "Culoare",
    "size": "Dimensiune",
    "toShow": "De afişare",
    "colors": "Culori",
    ...
    "range": "Distanţă",
    "othersSymbol": "Altele",
    "othersSymbolTip": "Afișați sau ascundeți simbolul pentru valorile necorelate."
  },
  "drawBox": {
    "point": "Punct",
    "arrow": "Săgeată",
  ...
  "filterBuilder": {
    "inputSearchKey": "Găsește sau creează o valoare",
    "createValue": "Creează valoare: ${value}",
    ...
    "oneOrZeroMsg": "Afişare caracteristici din stratul tematic care se potrivesc cu următoarea expresie",
    "matchMsgAny": "Afișează caracteristicile din stratul tematic care corespund oricărei expresii de mai jos",
    "matchMsgAll": "Afișează caracteristicile din stratul tematic care corespund tuturor expresiilor de mai jos",
    "matchMsgSetAny": "Oricare dintre expresiile următoare din acest set sunt reale",
    "matchMsgSetAll": "Toate expresiile următoare din acest set sunt reale",
    "all": "Toate",
    "any": "Oricare",
    "value": "Valoare",
    "values": "Valori",
    "field": "Câmp",
    "unique": "Unice",
    "uniquePredefined": "Unic (predefinit)",
    "multiple": "Multiplu",
    "multiplePredefined": "Multiplu (predefinit)",
    "predefinedUniqueTips": "Predefiniți valori unice",
    "predefinedMultipleTips": "Predefiniți valori multiple",
    "displayAs": "Afişare ca",
    "aDrowdownList": "listă verticală",
    "aExpandedList": "listă extinsă",
    "addValuePlaceHolder": "Faceți dublu clic pentru a seta o valoare",
    "addLabelPlaceHolder": "Faceți dublu clic pentru a seta o etichetă",
    "emptyValueTips": "Afișați sau ascundeți valoarea goală din această listă.",
    "showAll": "Afișare toate",
    "showSelected": "Afișare doar obiecte selectate",
    "unCheckAll": "Debifare toate",
    "noData": "Nu există nicio dată.",
    "none": "Niciunul",
    "and": "şi",
    ...
    "stringOperatorIsIn": "este în",
    "stringOperatorIsNotIn": "nu este în",
    "stringOperatorIsAnyOf": "este vreunul din",
    "stringOperatorIsNoneOf": "nu este niciunul din",
    ...
    "numberOperatorIsAnyOf": "este vreunul din",
    "numberOperatorIsNoneOf": "nu este niciunul din",
    ...
    "notSupportCaseSensitiveTip": "Serviciile găzduite ArcGIS Online nu suportă interogații sensibile la majuscule/minuscule.",
    "setFilterTip": "Setaţi corect filtrele.",
    "noFilterValueTip": "Câmpul specificat nu are nicio valoare.",
    "listValues": "Valori listă",
    "cascadeFilterTip": "Afișați doar valorile filtrate de expresiile anterioare",
  ...
  "itemSelector": {
    ...
    "searchNone": "Nu am putut găsi ceea ce căutați. Încercați din nou.",
    "groups": "Grupuri",
  ...
  "units": {
    ...
    "degrees": "Grade",
    "degreeMS": "Grad-Minut-Secundă",
    "degreesAbbr": "grd zecimale",
    "degreeMSAbbr": "grd min sec",
  ...
  "featureSetChooser": {
    ...
    "selectByPoint": "Selectaţi prin trasare punct",
    ...
    "selectByFreehandPolygon": "Selectare prin trasare lasou",
  ...
  "shareLink": {
    ...
    "useOrg": "Utilizarea adresei URL a organizației",
    "layerVisibility": "Reţineţi vizibilitatea stratului tematic",
    ...
    "urlEncodedTips": "ID-urile de strat tematic sunt codificate cu algoritmul hash pentru a scurta adresa URL, deoarece sunt prea multe informații privind vizibilitatea stratului tematic. Consultați ajutorul pentru widgetul Partajare pentru mai multe detalii.",
    "urlTooLongTips": "Adresa URL actuală este prea lungă și s-ar putea să nu poată fi interpretată de server. Puteți ignora informațiile privind vizibilitatea pentru a-l scurta. Consultați ajutorul pentru widgetul Partajare pentru mai multe detalii."
  },
  "webSceneLoader": {
  ...
  "statisticsChart": {
    ...
    "color": "Culoare",
    "fieldDisplayChartTip": "Eroare la afişarea diagramei. Prea multe categorii.",
    "legend": "Legendă",
    "columnChart": "Diagramă cu coloane",
    "pieChart": "Diagramă radială",
    "barChart": "Diagramă cu bare",
    "lineChart": "Diagramă liniară"
  },
  "frameworkDatasource": {
  ...
  "coordinateControl": {
    ...
    "copySuccessful": "Copiere reușită",
    "copyFailed": "Imposibil de copiat. Utilizați ctrl+c ca alternativă.",
    ...
    "latLongWarningMessage": "Coordonata de intrare a fost detectată ca având și prefix și sufix pentru valoarea de latitudine sau longitudine, coordonata returnată se bazează pe prefix.",
    "cancelButtonLabel": "Anulare",
    "applyButtonLabel": "Aplicare",
    "posNegPrefixLabel": "Adăugați prefixul „+/-” la numerele pozitive și negative",
    "editCoordinateDialogTitle": "Setare șir format coordonate",
    "rememberDecisionLabel": "Doresc să mi se rețină decizia și să nu mai fiu întrebat(ă) pe viitor.<br/>",
    "coordinateInputLabel": "Introduceți coordonatele sau faceți clic pe hartă",
    "zoomLabel": "Zoom",
    "addPointLabel": "Adăugarea unui punct prin efectuarea unui clic pe hartă",
    "multipleNotationLabel": "notații găsite care se potrivesc cu intrarea dvs. Confirmați ce doriți să utilizați:",
    "copyToClipboard": "Copiere în clipboard",
    "formatOutput": "Ieșire format",
    "notationAddedMessage": "Notație nouă adăugată",
