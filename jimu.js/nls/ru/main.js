define({
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Разложить окно",
    "maxWindow": "Развернуть окно",
    "restoreWindow": "Восстановить окно до размеров по умолчанию",
    "closeWindow": "Закрыть окно",
    "expanded": "Виджет ${value} развернут",
    "collapsed": "Виджет ${value} свернут",
    "pressToFocus": "Нажмите Enter для фокусировки внутри ${value}"
  },
  "toggleButton": {
    "toggleOn": "Нажмите кнопку переключения, чтобы включить",
    "toggleOff": "Нажмите кнопку переключения, чтобы отключить",
    "toggleOnTimePicker": "Включить указатель времени",
    "toggleOffTimePicker": "Отключить указатель времени"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Просмотр",
    "markerCategory": "Категория маркера",
    "basic": "Базовый",
    "arrows": "Стрелки",
    "business": "Бизнес",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Значение ${value} уже существует.",
    "color": "Цвет",
    "size": "Размер",
    "toShow": "Показать",
    "colors": "Цвета",
    ...
    "range": "Диапазон",
    "othersSymbol": "Другие",
    "othersSymbolTip": "Показать или скрыть символ для не сопоставленных значений."
  },
  "drawBox": {
    "point": "Точка",
    "arrow": "Стрелка",
  ...
  "filterBuilder": {
    ...
    "emptyValueTips": "Показать или скрыть пустое значение в списке.",
  ...
  "shareLink": {
    ...
    "layerVisibility": "Запомнить видимость слоя",
    ...
    "urlEncodedTips": "ID слоев кодируются хэш-алгоритмом для сокращения URL-адреса, так как много лишней информации о видимости слоя. Обратитесь к справке виджета Публикация для подробной информации.",
    "urlTooLongTips": "Текущий URL слишком длинный и не может быть интерпретирован сервером. Вы можете игнорировать информацию о видимости укорочения его. Обратитесь к справке виджета Публикация для подробной информации."
  },
  "webSceneLoader": {
  ...
  "statisticsChart": {
    ...
    "barChart": "Линейная диаграмма",
    "lineChart": "Диаграмма-график"
  },
  "frameworkDatasource": {
  ...
  "coordinateControl": {
    ...
    "addPointLabel": "Добавьте точку на карте, щелкнув",
    "multipleNotationLabel": "найденные уведомления, соответствующие входным данным. Выберите, что вы хотите использовать:",
