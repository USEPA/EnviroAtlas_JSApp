define({
  "common": {
    ...
    "updateGeometry": "Uppdatera geometri",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Visa fönster",
    "maxWindow": "Maximera fönster",
    "restoreWindow": "Återställ fönstret till standardstorlek",
    "closeWindow": "Stäng fönster",
    "expanded": "${value}-widget visad",
    "collapsed": "${value}-widget dold",
    "pressToFocus": "tryck på Enter för att fokusera inuti ${value}"
  },
  "toggleButton": {
    "toggleOn": "Slå på den med växlingsknappen",
    "toggleOff": "Slå av den med växlingsknappen",
    "toggleOnTimePicker": "Slå på tidsväljaren",
    "toggleOffTimePicker": "Slå av tidsväljaren"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    ...
    "emergencyManagement": "Nödsituationer och katastrofberedskap",
    "generalInfrastructure": "Allmän infrastruktur",
    "localGovernment": "Lokala myndigheter",
    ...
    "stateGovernment": "Statliga myndigheter",
    "shapes": "Objekt",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Värdet ${value} finns redan.",
    "color": "Färg",
    "size": "Storlek",
    "toShow": "Att visa",
    "colors": "Färger",
    ...
    "range": "Intervall",
    "othersSymbol": "Övriga",
    "othersSymbolTip": "Visa eller dölj symbolen för omatchade värden."
  },
  "drawBox": {
    "point": "Punkt",
    "arrow": "Pil",
  ...
  "filterBuilder": {
    "inputSearchKey": "Hitta eller skapa ett värde",
    "createValue": "Skapa värde: ${value}",
    "addAnotherExpression": "Lägg till uttryck",
    "addSet": "Lägg till uppsättning",
    ...
    "oneOrZeroMsg": "Visa geoobjekt i lagret som matchar följande uttryck",
    "matchMsgAny": "Visa geoobjekt i lagret som matchar något av följande uttryck",
    "matchMsgAll": "Visa geoobjekt i lagret som matchar alla följande uttryck",
    "matchMsgSetAny": "Ett eller flera av följande uttryck i uppsättningen är sanna",
    "matchMsgSetAll": "Alla följande uttryck i uppsättningen är sanna",
    "all": "Alla",
    "any": "Något",
    "value": "Värde",
    "values": "Värden",
    "field": "Fält",
    "unique": "Unik",
    "uniquePredefined": "Unika (fördefinierade)",
    "multiple": "Flera",
    "multiplePredefined": "Flera (fördefinierade)",
    "predefinedUniqueTips": "Fördefiniera unika värden",
    "predefinedMultipleTips": "Fördefiniera flera värden",
    "displayAs": "Visa som",
    "aDrowdownList": "listruta",
    "aExpandedList": "utökad lista",
    "addValuePlaceHolder": "Dubbelklicka för att ange värde",
    "addLabelPlaceHolder": "Dubbelklicka för att ange etikett",
    "emptyValueTips": "Visa eller dölj tomma värden i listan.",
    "showAll": "Visa alla",
    "showSelected": "Visa endast valda",
    ...
    "stringOperatorIsIn": "finns i",
    "stringOperatorIsNotIn": "finns inte i",
    ...
    "dateOperatorIsOn": "är",
    "dateOperatorIsIn": "finns i",
    "dateOperatorIsNotIn": "finns inte i",
    ...
    "notSupportCaseSensitiveTip": "Värdbaserade ArcGIS Online-tjänster stöder inte skiftlägeskänsliga frågor.",
    "setFilterTip": "Ange filtren korrekt.",
    "noFilterValueTip": "Det angivna fältet har inga värden.",
    ...
    "thisQuarter": "det här kvartalet",
    "thisYear": "det här året",
    "inputType": "Indatatyp",
    "setInputType": "Ange indatatyp"
  },
  "featureLayerSource": {
    "layer": "Lager",
    "browse": "Bläddra",
  ...
  "shareLink": {
    ...
    "useOrg": "Använda organisationens URL",
    "layerVisibility": "Kom ihåg lagrets synlighet",
    ...
    "urlEncodedTips": "Lager-ID är kodade med en hash-algoritm för att förkorta URL:en, eftersom det finns för mycket lagersynlighetsinformation. Mer information finns i hjälpen för delningswidgeten.",
    "urlTooLongTips": "Aktuell URL är för lång och kan inte tolkas av servern. Du kan ignorera synlighetsinformation för att förkorta den. Mer information finns i hjälpen för delningswidgeten."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Vill du avsluta utan att spara ändringarna?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Färg",
    "fieldDisplayChartTip": "Det gick inte att visa diagrammet. För många kategorier.",
    "legend": "Teckenförklaring",
    "columnChart": "Stapeldiagram",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "Zooma",
    "addPointLabel": "Lägg till punkt genom kartklick",
    "multipleNotationLabel": "notationer hittades som matchar inmatningen. Markera vilka du vill använda:",
