define({
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "กางหน้าต่าง",
    "maxWindow": "ขยายหน้าต่างให้เต็มจอ",
    "restoreWindow": "คืนค่าหน้าต่างกลับเป็นขนาดเริ่มต้น",
    "closeWindow": "ปิดหน้าต่าง",
    "expanded": "ขยาย ${value} วิดเจ็ท",
    "collapsed": "ย่อ ${value} วิดเจ็ท",
    "pressToFocus": "กด Enter เพื่อโฟกัสภายใน ${value}"
  },
  "toggleButton": {
    "toggleOn": "กดปุ่มสลับเพื่อเปิด",
    "toggleOff": "กดปุ่มสลับเพื่อปิด",
    "toggleOnTimePicker": "เปิดตัวเลือกเวลา",
    "toggleOffTimePicker": "ปิดตัวเลือกเวลา"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "ภาพตัวอย่าง",
    "markerCategory": "หมวดหมู่มาร์คเกอร์",
    "basic": "ระดับพื้นฐาน",
    "arrows": "ลูกศร",
    "business": "ธุรกิจ",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "มีค่า ${value} อยู่แล้ว",
    "color": "สี",
    "size": "ขนาด",
    ...
    "range": "ลำดับ",
    "othersSymbol": "อื่นๆ",
    "othersSymbolTip": "แสดงหรือซ่อนสัญลักษณ์สำหรับค่าที่ไม่ตรงกัน"
  },
  "drawBox": {
    "point": "จุด",
    "arrow": "ลูกศร",
  ...
  "filterBuilder": {
    ...
    "emptyValueTips": "แสดงหรือซ่อนค่าที่ว่างเปล่าในรายการนี้",
    "showAll": "แสดงทั้งหมด",
    ...
    "stringOperatorIsIn": "อยู่ใน",
    "stringOperatorIsNotIn": "ไม่ได้อยู่ใน",
    ...
    "cascadeFilterTip": "แสดงเฉพาะค่าที่กรองตามนิพจน์ก่อนหน้า",
  ...
  "itemSelector": {
    ...
    "searchNone": "เราไม่พบสิ่งที่คุณกำลังหา โปรดลองอีกครั้ง",
    "groups": "กลุ่ม :",
  ...
  "shareLink": {
    ...
    "layerVisibility": "จดจำการแสดงชั้นข้อมูล",
    ...
    "urlEncodedTips": "ID ชั้นข้อมูลถูกเข้ารหัสไว้ด้วยอัลกอริธึม Hash เพื่อให้ URL สั้นลง เนื่องจากมีข้อมูลที่แสดงผลบนชั้นข้อมูลมากเกินไป โปรดดูรายละเอียดเพิ่มเติมที่วิธีใช้วิดเจ็ท Share",
    "urlTooLongTips": "URL ปัจจุบันยาวเกินไป และเซิร์ฟเวอร์อาจไม่สามารถแปลข้อมูลได้ คุณสามารถละเว้นข้อมูลที่แสดงผล เพื่อทำให้สั้นลงได้ โปรดดูรายละเอียดเพิ่มเติมที่วิธีใช้วิดเจ็ท Share"
  },
  "webSceneLoader": {
  ...
  "coordinateControl": {
    ...
    "copyFailed": "ไม่สามารถคัดลอกได้ โปรดใช้ ctrl+c แทน",
    ...
    "applyButtonLabel": "นำไปใช้",
    "posNegPrefixLabel": "เพิ่มคำนำหน้า \"+/-\" เป็นตัวเลขบวกและลบ",
    "editCoordinateDialogTitle": "ตั้งค่าระบบพิกัดรูปแบบสตริง",
    "rememberDecisionLabel": "จำการตัดสินใจของฉันและไม่ต้องถามอีก<br/>",
    "coordinateInputLabel": "กรอกค่าพิกัดหรือคลิกบนแผนที่",
    "zoomLabel": "ขยาย",
    "addPointLabel": "เพิ่มจุดจากการคลิกแผนที่",
    "multipleNotationLabel": "หมายเหตุที่พบซึ่งตรงกับอินพุทของคุณ โปรดยืนยันสิ่งที่คุณต้องการใช้:",
