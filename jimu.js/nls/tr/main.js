define({
  "common": {
    ...
    "updateGeometry": "Geometriyi güncelle",
    "preview": "Önizleme",
    "date": "Tarih",
    "time": "Saat",
    "show": "Göster",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Pencereyi düzleştir",
    "maxWindow": "Pencereyi maksimize et",
    "restoreWindow": "Pencereyi varsayılan boyuta getir",
  ...
  "toggleButton": {
    ...
    "toggleOff": "Kapatmak için geçiş düğmesine basın",
    "toggleOnTimePicker": "Zaman seçiciyi aç",
    "toggleOffTimePicker": "Zaman seçiciyi kapat"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Önizleme",
    "markerCategory": "İşaretçi Kategorisi",
    "basic": "Temel",
    "arrows": "Oklar",
    "business": "İş",
    ...
    "generalInfrastructure": "Genel Altyapı",
    "localGovernment": "Yerel Hükümet",
    ...
    "pointsOfInterest": "İlgi Alanları",
    "safetyHealth": "Güvenlik sağlık",
    "stateGovernment": "Bölge Yönetimi",
    "shapes": "Şekiller",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Değer ${value} zaten var.",
    "color": "Renk",
    "size": "Boyut",
    ...
    "label": "Etiket",
    "range": "Aralık",
    "othersSymbol": "Diğerleri",
    "othersSymbolTip": "Eşleşmeyen değerler için sembolü göster veya gizle."
  },
  "drawBox": {
    "point": "Nokta",
    "arrow": "Ok",
  ...
  "filterBuilder": {
    "inputSearchKey": "Bir değer bulun veya oluşturun",
    "createValue": "Değer oluştur: ${value}",
    ...
    "oneOrZeroMsg": "Katmandaki aşağıdaki ifadeyle eşleşen detayları görüntüle",
    "matchMsgAny": "Katmanda, aşağıdaki ifadelerin herhangi biriyle eşleşen detayları göster",
    "matchMsgAll": "Katmanda, aşağıdaki ifadelerin tümüyle eşleşen detayları göster",
    "matchMsgSetAny": "Bu sette aşağıdaki ifadelerin herhangi biri doğru",
    "matchMsgSetAll": "Bu sette aşağıdaki ifadelerin tümü doğru",
    "all": "Tümü",
    "any": "Bir Kısmı",
    "value": "Değer",
    "values": "Değerler",
    ...
    "predefinedUniqueTips": "Benzersiz değerleri ön tanımla",
    "predefinedMultipleTips": "Çoklu değerleri ön tanımla",
    "displayAs": "Farklı görüntüle",
    "aDrowdownList": "açılan liste",
    "aExpandedList": "genişletilmiş liste",
    "addValuePlaceHolder": "Değer belirlemek için çift tıklayın",
    "addLabelPlaceHolder": "Etiket belirlemek için çift tıklayın",
    "emptyValueTips": "Bu listedeki boş değeri göster veya gizle.",
    "showAll": "Tümünü göster",
    "showSelected": "Yalnızca seçilenleri göster",
    "unCheckAll": "Tümünün işaretini kaldır",
    "noData": "Veri yok.",
    "none": "Yok",
    "and": "ve",
    ...
    "stringOperatorIsIn": "şunun içindedir",
    "stringOperatorIsNotIn": "şunun içinde değildir",
    ...
    "notSupportCaseSensitiveTip": "ArcGIS Online barındırılan hizmetler büyük küçük harf duyarlı sorgulamayı desteklemez.",
    "setFilterTip": "Filtreleri düzgün şekilde ayarlayın.",
    "noFilterValueTip": "Belirtilen alanda hiçbir değer yok.",
    ...
    "setInputType": "Girdi türünü ayarla"
  },
  "featureLayerSource": {
    "layer": "Katman",
    "browse": "Gözat",
  ...
  "shareLink": {
    ...
    "useOrg": "Kuruluşun URL’sini kullan",
    "layerVisibility": "Katmanların görünürlüğünü hatırla",
    ...
    "urlEncodedTips": "Katman kimlikleri, çok fazla katman görünürlük bilgisi olduğundan URL'yi kısaltmak için Çizgi algoritması ile kodlanmıştır. Daha fazla ayrıntı için Paylaşım aracı yardımına bakın.",
    "urlTooLongTips": "Geçerli URL aşırı uzundur ve sunucu tarafından yorumlanmayabilir. Kısaltmak için görünürlük bilgilerini dikkate almayabilirsiniz. Daha fazla ayrıntı için Paylaşım aracı yardımına bakın."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Düzenlemeleri kaydetmeden ayrılmak istiyor musunuz?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Renkli",
    "fieldDisplayChartTip": "Çizge görüntülenemedi. Çok fazla kategori.",
    "legend": "Gösterge",
    "columnChart": "Sütun grafiği",
  ...
  "coordinateControl": {
    ...
    "DMSLatLongNotation": "Derece Dakika Saniye - Enlem/Boylam",
    "DMSLongLatNotation": "Derece Dakika Saniye - Boylam/Enlem",
    "GARSNotation": "GARS",
    ...
    "comfirmInputNotation": "Girdi Kaydını Onayla",
    "latLongWarningMessage": "Girdi koordinatında enlem veya boylam değeri için hem ön hem de son ek olduğu algılandı, döndürülen koordinat ön eke göredir.",
    "cancelButtonLabel": "İptal Et",
    "applyButtonLabel": "Uygula",
    "posNegPrefixLabel": "Pozitif ve negatif sayıların önüne “+/-” işareti ekleyin",
    "editCoordinateDialogTitle": "Koordinat Biçimi Dizisini Ayarla",
    ...
    "addPointLabel": "Harita tıklama kayıtlarının girdinizle eşleşiyor olarak bulduğu",
    "multipleNotationLabel": "noktaları ekleyin. Hangisini kullanmak istediğinizi belirtin:",
    "copyToClipboard": "Panoya kopyala",
    "formatOutput": "Biçim çıktısı",
    "notationAddedMessage": "Yeni Kayıt Eklendi",
