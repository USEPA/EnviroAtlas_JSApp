define({
  "common": {
    ...
    "updateGeometry": "Cập nhật hình học",
    "preview": "Xem trước",
    "date": "Ngày",
    "time": "Thời gian",
    "show": "Hiển thị",
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "Mở cửa sổ",
    "maxWindow": "Phóng to cửa sổ hết cỡ",
    "restoreWindow": "Khôi phục cửa sổ về kích thước mặc định",
    "closeWindow": "Đóng cửa sổ",
    "expanded": "Tiện ích ${value} được mở rộng",
    "collapsed": "Tiện ích ${value} được thu gọn",
    "pressToFocus": "nhấn Enter tập trung vào bên trong ${value}"
  },
  "toggleButton": {
    "toggleOn": "Nhấn nút chuyển đổi để bật",
    "toggleOff": "Nhấn nút chuyển đổi để tắt",
    "toggleOnTimePicker": "Bật công cụ chọn thời gian",
    "toggleOffTimePicker": "Tắt công cụ chọn thời gian"
  },
  "fieldStatistics": {
  ...
  "symbolChooser": {
    "preview": "Xem trước",
    "markerCategory": "Danh mục Đánh dấu",
    "basic": "Cơ bản",
    "arrows": "Mũi tên",
    "business": "Kinh doanh",
    "cartographic": "Bản đồ",
    "damage": "Thiệt hại",
    "disasters": "Thảm họa",
    "emergencyManagement": "Quản lý Khẩn cấp",
    "generalInfrastructure": "Hạ tầng Chung",
    "localGovernment": "Chính quyền Địa phương",
    "nationalParkService": "Cục công viên quốc gia",
    "numbers": "Numbers",
    "outdoorRecreation": "Giải trí ngoài trời",
    "peoplePlaces": "Địa điểm công cộng",
    "pointsOfInterest": "Điểm quan tâm",
    "safetyHealth": "Sức khỏe an toàn",
    "stateGovernment": "Chính quyền Tiểu bang",
  ...
  "rendererChooser": {
    ...
    "duplicatedValue": "Giá trị ${value} đã tồn tại.",
    "color": "Màu sắc",
    "size": "Kích cỡ",
    "toShow": "Thể hiện",
    "colors": "Màu sắc",
    ...
    "range": "Phạm vi",
    "othersSymbol": "Khác",
    "othersSymbolTip": "Hiện hoặc ẩn biểu tượng cho các giá trị không khớp."
  },
  "drawBox": {
    "point": "Điểm",
    "arrow": "Mũi tên",
  ...
  "filterBuilder": {
    "inputSearchKey": "Tìm hoặc tạo một giá trị",
    "createValue": "Tạo giá trị: ${value}",
    ...
    "oneOrZeroMsg": "Hiển thị các đối tượng trong lớp trùng khớp với biểu thức sau đây",
    "matchMsgAny": "Hiển thị các đối tượng trong lớp trùng khớp với bất kỳ biểu thức nào sau đây",
    "matchMsgAll": "Hiển thị các đối tượng trong lớp trùng khớp với tất cả biểu thức sau",
    "matchMsgSetAny": "Bất kỳ biểu thức nào sau đây trong bộ này là đúng",
    "matchMsgSetAll": "Tất cả các biểu thức sau trong bộ này là đúng",
    "all": "Tất cả",
    "any": "Bất kỳ",
    "value": "Giá trị",
    "values": "Giá trị",
    "field": "Trường",
    "unique": "Duy nhất",
    "uniquePredefined": "Duy nhất (định sẵn)",
    "multiple": "Nhiều lớp",
    "multiplePredefined": "Nhiều lớp (định sẵn)",
    "predefinedUniqueTips": "Định sẵn các giá trị duy nhất",
    "predefinedMultipleTips": "Định sẵn các giá trị nhiều lớp",
    "displayAs": "Hiển thị dưới dạng",
    "aDrowdownList": "một danh sách thả xuống",
    "aExpandedList": "một danh sách mở rộng",
    "addValuePlaceHolder": "Nhấp đúp để thiết lập giá trị",
    "addLabelPlaceHolder": "Nhấp đúp để thiết lập nhãn",
    "emptyValueTips": "Hiện hoặc ẩn giá trị trống trong danh sách này.",
    "showAll": "Hiện tất cả",
    "showSelected": "Chỉ hiện các mục được chọn",
    ...
    "stringOperatorIsIn": "trong",
    "stringOperatorIsNotIn": "không trong",
    ...
    "dateOperatorIsIn": "trong",
    "dateOperatorIsNotIn": "không trong",
    ...
    "notSupportCaseSensitiveTip": "Dịch vụ được lưu trữ ArcGIS Online không hỗ trợ truy vấn phân biệt chữ hoa chữ thường.",
    "setFilterTip": "Vui lòng thiết lập bộ lọc chính xác.",
    "noFilterValueTip": "Trường được xác định không có giá trị nào.",
  ...
  "timeUnit": {
    ...
    "second": "Giây",
    "seconds": "Giây",
    "milliSecond": "Milli giây",
    "milliSeconds": "Milli giây"
  },
  "featureSetChooser": {
    "select": "Chọn",
    "dragBox": "Kéo",
  ...
  "shareLink": {
    ...
    "useOrg": "Sử dụng URL của tổ chức",
    "layerVisibility": "Ghi nhớ khả năng hiển thị lớp",
    ...
    "urlEncodedTips": "ID Lớp được mã hóa bằng thuật toán Hash để rút gọn URL, do có quá nhiều thông tin về khả năng hiển thị của lớp. Vui lòng xem phần trợ giúp của tiện ích Chia sẻ để biết thêm thông tin.",
    "urlTooLongTips": "URL hiện tại quá dài và máy chủ có thể không hiểu được. Bạn có thể bỏ qua thông tin về khả năng hiển thị để rút gọn. Vui lòng xem phần trợ giúp của tiện ích Chia sẻ để biết thêm thông tin."
  },
  "webSceneLoader": {
  ...
  "popup": {
    ...
    "leaveConfirm": "Bạn có muốn rời đi mà không lưu các thông tin đã sửa đổi không?"
  },
  "queryFeatures": {
  ...
  "statisticsChart": {
    ...
    "color": "Màu sắc",
    "fieldDisplayChartTip": "Không hiển thị được biểu đồ. Có quá nhiều danh mục.",
    "legend": "Chú giải",
    "columnChart": "Biểu đồ cột dọc",
    "pieChart": "Biểu đồ hình tròn",
    "barChart": "Biểu đồ cột ngang",
  ...
  "coordinateControl": {
    ...
    "copyFailed": "Không thể Sao chép. Hãy sử dụng ctrl+c để thay thế.",
    ...
    "zoomLabel": "Thu phóng",
    "addPointLabel": "Thêm điểm từ nhấp vào bản đồ",
    "multipleNotationLabel": "tìm thấy ký hiệu khớp với đầu vào của bạn. Vui lòng xác nhận mục bạn muốn sử dụng:",
