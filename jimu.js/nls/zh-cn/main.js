define({
  ...
  "toggleButton": {
    "toggleOn": "按切换按钮将其打开",
    "toggleOff": "按切换按钮将其关闭",
    "toggleOnTimePicker": "打开时间选择器",
    "toggleOffTimePicker": "关闭时间选择器"
  },
  "fieldStatistics": {
    "selectField": "选择字段",
    "statistics": "统计数据",
  ...
  "shareLink": {
    ...
    "auth": "自动验证用户",
    "useOrg": "使用组织的 URL",
    "layerVisibility": "记住图层可见性",
    "linkPreview": "链接预览",
    "useShortenLink": "短链接",
    "shareMapUrlExtent": "共享当前地图范围",
    "shareToWebTips": "此应用程序未向公众进行共享。用户可能无法查看此应用程序。",
    "urlEncodedTips": "由于图层可见性信息过多，请使用哈希算法对图层 ID 进行编码以缩短 URL。 有关详细信息，请参阅共享微件帮助。",
    "urlTooLongTips": "当前 URL 过长，服务器可能无法对其进行解析。 您可以忽略可见性信息以将其缩短。 有关详细信息，请参阅共享微件帮助。"
  },
  "webSceneLoader": {
