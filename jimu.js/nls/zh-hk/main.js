define({
  ...
  "panelHeader": {
    ...
    "unfoldWindow": "展開視窗",
    "maxWindow": "最大化視窗",
    "restoreWindow": "將視窗還原為預設大小",
    "closeWindow": "關閉視窗",
    "expanded": "已展開 ${value} widget",
    "collapsed": "已折疊 ${value} widget",
    "pressToFocus": "按下 Enter 以聚焦於 ${value} 內部"
  },
  "toggleButton": {
    "toggleOn": "按下切換按鈕以開啟它",
    "toggleOff": "按下切換按鈕以關閉它",
    "toggleOnTimePicker": "開啟時間選取器",
    "toggleOffTimePicker": "關閉時間選取器"
  },
  "fieldStatistics": {
    "selectField": "選擇欄位",
    "statistics": "統計資料",
  ...
  "symbolChooser": {
    ...
    "damage": "損失",
    "disasters": "災害",
    "emergencyManagement": "緊急管理",
    "generalInfrastructure": "一般基礎設施",
    "localGovernment": "地方政府",
    "nationalParkService": "國家公園管理局",
    "numbers": "數字",
    "outdoorRecreation": "戶外娛樂",
    "peoplePlaces": "人員位置",
    "pointsOfInterest": "興趣點",
    "safetyHealth": "安全健康",
    "stateGovernment": "州政府",
    "shapes": "形狀",
    "transportation": "交通運輸",
  ...
  "filterBuilder": {
    "inputSearchKey": "尋找或建立值",
    "createValue": "建立值: ${value}",
    "addAnotherExpression": "新增表達式",
    "addSet": "新增集合",
    "matchMsg": "取得圖層中與以下 ${any_or_all} 表達式相符的圖徵",
    "matchMsgSet": "此集合中的以下 ${any_or_all} 表達式為 true",
    "oneOrZeroMsg": "顯示圖層中符合以下表達式的圖徵",
    "matchMsgAny": "顯示圖層中與下列任何表達式相符的圖徵",
    "matchMsgAll": "顯示圖層中與下列所有表達式相符的圖徵",
    "matchMsgSetAny": "此集合中的下列任何表達式為 true",
    "matchMsgSetAll": "此集合中的下列所有表達式為 true",
    "all": "全部",
    "any": "任意",
    "value": "值",
    "values": "值",
    "field": "欄位",
    "unique": "唯一",
    "uniquePredefined": "唯一 (預定義)",
    "multiple": "多個",
    "multiplePredefined": "多個 (預定義)",
    "predefinedUniqueTips": "預定義唯一值",
    "predefinedMultipleTips": "預定義多個值",
    "displayAs": "顯示為",
    "aDrowdownList": "下拉式清單",
    "aExpandedList": "展開的清單",
    "addValuePlaceHolder": "按兩下以設定值",
    "addLabelPlaceHolder": "按兩下以設定標籤",
    "emptyValueTips": "顯示或隱藏此清單中的空值。",
    "showAll": "顯示全部",
    "showSelected": "僅顯示所選項",
    "unCheckAll": "全部取消勾選",
    "noData": "沒有資料。",
    ...
    "stringOperatorIsIn": "位於",
    "stringOperatorIsNotIn": "不在其中",
    ...
    "caseSensitive": "區分大小寫",
    "notSupportCaseSensitiveTip": "ArcGIS Online 託管的服務不支援區分大小寫的查詢。",
    "setFilterTip": "請正確設定篩選器。",
    "noFilterValueTip": "指定的欄位沒有值。",
    "listValues": "清單值",
  ...
  "shareLink": {
    ...
    "auth": "自動驗證使用者",
    "useOrg": "使用組織的 URL",
    "layerVisibility": "記住圖層能見度",
    "linkPreview": "連結預覽",
    "useShortenLink": "短連結",
    "shareMapUrlExtent": "共用目前地圖範圍",
    "shareToWebTips": "此應用程式未向大眾進行共用。使用者可能無法檢視此場景。",
    "urlEncodedTips": "由於圖層可見性資訊過多，已使用雜湊演算法編碼圖層 ID 以縮短 URL。 如需詳細資訊，請參閱分享 widget 說明。",
    "urlTooLongTips": "目前的 URL 太長，伺服器無法解譯。 您可以忽略可見性資訊來忽略它。 如需詳細資訊，請參閱分享 widget 說明。"
  },
  "webSceneLoader": {
  ...
  "statisticsChart": {
    ...
    "dataLabels": "資料標籤",
    "color": "顏色",
    "fieldDisplayChartTip": "無法顯示圖表，類別過多。",
    "legend": "圖例",
    "columnChart": "柱形圖",
    "pieChart": "圓餅圖",
    "barChart": "長條圖",
  ...
  "coordinateControl": {
    ...
    "zoomLabel": "縮放",
    "addPointLabel": "從地圖新增點，按一下",
    "multipleNotationLabel": "符合您輸入的標記法。 請確認您要使用哪個標記法:",
