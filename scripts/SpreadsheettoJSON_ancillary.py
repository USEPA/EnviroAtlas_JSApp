...
def main(_argv):
    ...
    for sheet in sheetList:
        ...
        for rowID in rowsToKeep:
            ...
            stringList = ["eaID","eaScale","eaDescription","eaMetric","eaDfsLink","eaLyrNum","eaMetadata","eaBC","eaCA","eaCPW","eaCS","eaFFM","eaNHM","eaRCA","eaPBS","eaTopic","tileLink","tileURL","tileLink","tileURL", "IsSubLayer", "SubLayerNames", "SubLayerIds"]
