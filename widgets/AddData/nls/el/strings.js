define({
  ...
  "search": {
    ...
    "scopeOptions": {
      ...
      "myOrganization": "Οργανισμός",
      "curated": "Επιμελημένο",
      "ArcGISOnline": "στο ArcGIS Online"
    },
    "sortOptions": {
  ...
  "addFromFile": {
    ...
    "featureLocationsCouldNotBeFound": "Δεν είναι δυνατός ο εντοπισμός των στοιχείων: άγνωστα ή μη έγκυρα πεδία τοποθεσίας. Το αρχείο θα προστεθεί ως πίνακας."
  },
  "layerList": {
    "caption": "Θεμ. επίπ.",
