define({
  "_widgetLabel": "Tambahkan Data",
  "noOptionsConfigured": "Tidak ada opsi dikonfigurasi.",
  "tabs": {
    "search": "Cari",
    "url": "URL",
    "file": "File"
  ...
  "search": {
    ...
    "resultsPane": {
      "noMatch": "Ttidak ada hasil yang ditemukan."
    },
    "paging": {
      "first": "<<",
      "firstTip": "Pertama",
  ...
  "addFromUrl": {
    ...
    "types": {
      ...
      "WMS": "Web Service WMS OGC",
      "WMTS": "Web Service WMTS OGC",
      "WFS": "Web Service WFS OGC",
      "KML": "File KML",
      "GeoRSS": "File GeoRSS",
      "CSV": "File CSV"
    },
  ...
  "addFromFile": {
    "intro": "Anda dapat drop atau menelusuri salah satu dari jenis file berikut:",
    "types": {
