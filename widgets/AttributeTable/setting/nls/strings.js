define({
  root: ({
    ...
    syncWithLayers: "Synchronize with layer visibilities",
    syncWithLayersHint: "The layers shown in Attribute Table are synchronized with layer visibilities dynamically."
  }),
  "ar": 1,
  "bs": 1,
  "ca": 1,
