...
_adjustToState: function () {
    ...
    dojo.forEach(this._serviceWidgets, function (a) {
        ...
        var layeruniqueid = mid + lid + "_map"+window.index_Demographics;
...
_genRender: function (renderobj) {
    ...
    generateRenderer.execute(params, function (renderer) {
        ...
        var layeridstr = window.layerIdDemographPrefix+ mapid + fieldid + "_map" +  window.index_Demographics;
        window.index_Demographics = window.index_Demographics + 1;
