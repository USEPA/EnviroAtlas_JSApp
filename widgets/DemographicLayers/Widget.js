...
startup: function () {
    ...
    document.getElementById('censusServiceSelectionHelp').onclick = function (e) {
        ...
        infotext = "<h2 style='margin-top:0px'>2016-2020 ACS</h2>";
        infotext += "<p>Variables derived from a subset of 2016-2020 American Community Survey data.</p>"
    ...
    if (dgObj.process) {
        ...
        function queryTaskProcessing(featset){
            if (featset.features.length > 0) {
                ...
                if (key == "acs2020") _config.demogJSON[key].tables = tableJson;
...
_genRender: function (renderobj) {
    ...
    var layeridstr = window.layerIdDemographPrefix+ mapid + fieldid + "_map";
 	setTimeout(lang.hitch(this, function() {       
        ...
        window.demographicLayerSetting[layeridstr]["serviceNode"] = selfDemographic.serviceNode.value; 			//It is Source such as: 2016-2020 ACS
