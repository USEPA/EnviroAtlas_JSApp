define(
    ...
    function() {
     var _config = {"demogJSON": {
        ...
        "ejdemog": { "title": "2017-2021 ACS", "tiptext": "2017-2021 ACS", "dynamic": false, "type": "agsdemog", "layerurl": "https://ejscreen.epa.gov/ArcGIS/rest/services/", "service": "ejscreen/census2021acs", "lookupindex": 4,
            "description": "2017-2021 ACS demographics are a set of variables derived based on a subset of 2017-2021 American Community Survey data.",
            "process": false,"transparency": "0.5", "identify": "yes", "filter": "yes","defaultCategory": "Population","defaultfield":"POP_DEN",
            "baselayers": {
                "bg": { "minlevel": 10, "maxlevel": 20,"renderobj":{}, "layeridx": 0, "level": "2017-2021 ACS (Blockgroup)","headerfields": { "STCNTRBG": "Blockgroup ID", "STUSAB": "State", "TOTALPOP": "Total Population"} }
                , "tr": { "minlevel": 8, "maxlevel": 10,"renderobj":{}, "layeridx": 1, "level": "2017-2021 ACS (Tract)", "headerfields": { "STCNTR": "Tract ID", "STUSAB": "State", "TOTALPOP": "Total Population"} }
                , "cnty": { "minlevel": 4, "maxlevel": 8,"renderobj":{}, "layeridx": 2, "level": "2017-2021 ACS (County)", "headerfields": { "CNTYNAME":"County Name","STUSAB":"State", "STCN": "County FIPS", "TOTALPOP": "Total Population"} }
                , "st": { "minlevel": 0, "maxlevel": 4,"renderobj":{}, "layeridx": 3, "level": "2017-2021 ACS (State)", "headerfields": { "STATE_NAME": "State", "TOTALPOP": "Total Population"} }
            },
            "dynamiclayers": {}
        }
