...
define(
  ...
  function (
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      getConfig:function(){
        if(!this.maxBufferValue.get('value') || this.maxBufferValue.get('value') === ''){
          delete this._bufferDefaults.maxBufferValue;
        } else {
          this._bufferDefaults.maxBufferValue = parseFloat(this.maxBufferValue.get('value'));
        }
