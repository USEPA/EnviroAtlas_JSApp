...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function() {
      ...
      this.own(on(this.partialMode, 'click', lang.hitch(this, this._onSelectPartialMode)));
      this.own(on(this.whollyMode, 'click', lang.hitch(this, this._onSelectWhollyMode)));
    ...
    _init: function() {
      ...
      if(this.config.selectionMode === PARTIAL_WITHIN) {
        this.partialMode.set('checked', true);
