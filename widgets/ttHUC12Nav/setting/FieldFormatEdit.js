...
define(
  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(fieldInfo){
        ...
        if(fieldInfo.isdate || this._isDateType(fieldInfo.type)){
          ...
          if(fieldInfo.sumfield){
            ...
            this.tbSumLabel.set('value', fieldInfo.sumlabel);
          }
      ...
      getConfig: function(){
        if(this.useStatCbx.getValue()){
          this.returnfieldInfo.excludestat = true;
        }else{
          this.returnfieldInfo.excludestat = false;
        }
        if(this.returnfieldInfo.isdate || this._isDateType(this.returnfieldInfo.type)){
          ...
          var currencyformat = '';
          var numberformat = '';
          if(this.useSumCbx.getValue()){
            this.returnfieldInfo.sumfield = this.useSumCbx.getValue();
            this.returnfieldInfo.sumlabel = this.tbSumLabel.get('value');
          }
